...
const ProjectCard = ({ project }) => {
    ...
    return (
        <div className={`flex flex-col-reverse justify-between border-b-2 border-teal-900 dark:border-stone-200 px-6 w-full max-w-screen h-[90%] lg:w-[190vh] lg:max-w-screen-xl lg:px-12 lg:flex-row ${project.id % 2 !== 0 && 'lg:flex-row-reverse'}`}>
            <div className="basis-2/3 text-center text-teal-900 align-center justify-center self-center dark:text-stone-200">
                ...
                <button className="p-2 mt-4 font-bold text-stone-200 text-lg mb-4 bg-teal-700 hover:bg-teal-900 rounded-full w-48 lg:text-xl lg:w-64 lg:mt-5 dark:bg-stone-200 dark:text-teal-900 dark:hover:bg-stone-400" onClick={() => navigate(`/projects/${project.id}`)}>
                    Read more
                </button>
            </div>
