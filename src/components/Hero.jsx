        ...
        <section className="h-screen py-12">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    <h1 className="max-w-2xl mb-4 pb-6 font-extrabold text-white drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] tracking-tight leading-none md:text-5xl xl:text-6xl">Hello, my name is Timur, I am a fullstack developer</h1>
