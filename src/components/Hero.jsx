            ...
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7 mt-12 md:mt-0">
                    ...
                    <div className="text-center md:text-start">
                        ...
                        <button className="inline-flex items-center justify-center px-5 py-3 mr-3 border border-teal-900 font-medium text-center text-teal-900 bg-transparent hover:bg-white rounded-full"><a href="google.com" target="_blank">Open my CV</a></button>
                    </div>
                </div>
